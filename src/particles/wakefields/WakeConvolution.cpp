...
namespace impactx::particles::wakefields
{
    ...
    )
    {
        ...
        amrex::FFT::LocalR2C<amrex::Real,amrex::FFT::Direction::forward>
            fft_p1{amrex::IntVect(padded_signal_size)};
        amrex::FFT::LocalR2C<amrex::Real,amrex::FFT::Direction::forward>
            fft_p2{amrex::IntVect(padded_signal_size)};

        // Perform Forward FFT - Convert inputs into frequency domain
        // Gives out1,out2, the FFT-transformed input arrays of in1, in2
        fft_p1.forward(in1.data(), out1.data());
        fft_p2.forward(in2.data(), out2.data());
        ...
        {
            dptr_conv_result[i] = dptr_out1[i] * dptr_out2[i];
        });
        ...
        amrex::FFT::LocalR2C<amrex::Real,amrex::FFT::Direction::backward>
            fft_p3{amrex::IntVect(padded_signal_size)};

        // Perform Backward FFT
        fft_p3.backward(dptr_conv_result, dptr_out3);
